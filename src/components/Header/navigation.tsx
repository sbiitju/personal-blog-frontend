export const navigationItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "বিশেষ প্রতিবেদন", href: "/category/informatics/special-articles" },
        { title: "স্মারক", href: "/category/informatics/commemoration" },
        { title: "বুকলেট/লিফলেট", href: "/category/informatics/booklet-leaflet" },
        ...
        { title: "ভিডিও গ্যালারী", href: "/category/informatics/video-gallery" },
       ],
    },
  ];